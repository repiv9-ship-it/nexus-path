...
import { ChevronRight, ChevronLeft, BookOpen, Video, FileText, Package, Megaphone, Search, Badge, Clock, Users } from 'lucide-react';
...
function SubjectPage({ subject, onBack }: { subject: Subject; onBack: () => void }) {
  ...
  const currentMaterials = subject.materials[activeTab] || [];
